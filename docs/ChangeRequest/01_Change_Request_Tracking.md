...
| **CR-RS-V2.4-BB-NEGATIVE-20260902** | **BB Negative LOWER Handling** | Calculation Engine / Bug Fix | Skip finite BB PRICE_LEVEL <= 0 candidates while preserving strict NaN/Infinity/semantic validation; unblock monthly historical evaluation | **IN PROGRESS** |  | **Focused local validation pending** | [CR_RS_V2_4_BB_Negative_Lower_Handling.md](./CR_RS_V2_4_BB_Negative_Lower_Handling.md) | PR #13 / validation pending |
