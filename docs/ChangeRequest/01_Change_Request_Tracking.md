...
| **CR-RS-V2.4-MONTHLY-20260902** | **R/S V2.4 Monthly Full Evaluation** | Operational / Orchestration / Research Governance | Active-universe monthly H5/H10/H20/H40 baseline reuse, runtime-aligned source discovery, source-config/family ablation, resumable deterministic runs, Promotion Gate dry-run | **PRODUCTION DEPLOYED** | **2026-09-02** | **PASS — original monthly validation + active-universe fix validated 11/11; plan reduced broad 1,491-ticker raw EOD universe to 340 active/eligible tickers using raw_lstTicker.status=Y; runtime unchanged** | [CR_RS_V2_4_Monthly_Full_Evaluation.md](./CR_RS_V2_4_Monthly_Full_Evaluation.md) | PR #9 / `eed1990c7bccc0475eb9ac83c2c187e3bebf2b65` + PR #10 / `cfd27e92056ac1ce21d7f887cfc8e5f9c120ef16` |
| **CR-RS-V2.4-BB-NEGATIVE-20260902** | **BB Negative LOWER Handling** | Calculation Engine / Bug Fix | Skip finite BB PRICE_LEVEL <= 0 candidates while preserving strict NaN/Infinity/semantic validation; unblock monthly historical evaluation | **VALIDATION PENDING** |  | **PASS — 6/6 focused BB + 28/28 ladder + golden + THD real-data smoke; merge pending behind PR #12** | [CR_RS_V2_4_BB_Negative_Lower_Handling.md](./CR_RS_V2_4_BB_Negative_Lower_Handling.md) | PR #13 / PASS KEEP / merge pending |
