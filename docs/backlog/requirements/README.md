...
- [[REQ-0033-active-ticker-movement-initload|REQ-0033 — Active Ticker ZigZag + Price Movement Initial Load]] — **IMPLEMENTED_PENDING_VALIDATION**; full active-universe rollout from `vw_Ticker_Active`, stage-separated ZigZag → Price Movement, per-ticker transaction isolation, and structural coverage validator.
