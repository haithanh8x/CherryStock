...
- [[REQ-0034-daily-incremental-movement-pipeline|REQ-0034 — Daily Incremental Movement Pipeline]] — **DONE / HISTORICAL SCHEDULING**; daily integration was validated, but normal scheduling is superseded by REQ-0036 because full-universe Movement costs ~60 minutes per trading day.
- [[REQ-0036-weekly-movement-pipeline|REQ-0036 — Weekly Full-Universe Movement Pipeline]] — **IMPLEMENTED_PENDING_VALIDATION**; moves normal Movement to `runWeekly.py`, keeps on-demand ticker repair, and adds Movement freshness fields/SLA.
